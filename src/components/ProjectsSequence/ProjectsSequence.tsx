...
import styles from './ProjectsSequence.module.css';
...
export default function ProjectsSequence({
  ...
  useEffect(() => {
    ...
    const onMetadata = () => {
      ...
      video.currentTime = reducedMotion ? safeTime(duration.current * 0.68) : safeTime(current.current);
  ...
  return (
    <div className={styles.visual} aria-hidden="true">
      ...
      <video
        ...
        src="/videos/andrey-chibi-portal-projects.mp4"
        poster="/videos/andrey-chibi-portal-poster.jpg"
        muted
        playsInline
        preload="auto"
        tabIndex={-1}
      ...
      <div className={styles.meta}><span>PROJECTS / LAUNCH</span><i /> 03</div>
    </div>
  );
}
