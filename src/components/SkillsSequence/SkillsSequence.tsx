...
import styles from './SkillsSequence.module.css';
...
export default function SkillsSequence({
  ...
  useEffect(() => {
    ...
    const onMetadata = () => {
      ...
      video.currentTime = reducedMotion ? safeTime(duration.current * 0.72) : safeTime(current.current);
  ...
  return (
    <div className={styles.visual} aria-hidden="true">
      ...
      <video
        ...
        src="/videos/andrey-chibi-stack-code.mp4"
        poster="/videos/andrey-chibi-stack-poster.jpg"
        muted
        playsInline
        preload="auto"
        tabIndex={-1}
      ...
      <div className={styles.meta}><span>STACK / RUNTIME</span><i /> ACTIVE</div>
    </div>
  );
}
